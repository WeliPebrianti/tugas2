...
<head>
    ...
    <!-- Site Metas -->
    <title>WELI PEBRIANTI FRUIT FRESH</title>
            ...
            <div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item active"><a class="nav-link" href="{{url('about_us')}}">About Us</a></li>
                        <li class="nav-item active"><a class="nav-link" href="{{url('shop')}}">Shop</a></li>
                        <li class="nav-item active"><a class="nav-link" href="{{url('gallery')}}">Gallery</a></li>
                        <li class="nav-item active"><a class="nav-link" href="{{url('contact_us')}}">Contact Us</a></li>
...
</html><h1>Ini halaman Gallery</h1>